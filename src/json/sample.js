    ...
    blocks: {
        ...
        Hi: {
            ...
            payload: {
                ...
                buttons: [
                    { title: "🛍️ Xem sản phẩm", next: "choose_category" },
                    { title: "🏬 Thôn`g tin cửa hàng", next: "store_info" },
                    { title: "🛡️ Chính sách bảo hành", next: "warranty_info" },
                ],
            },
        },
            ...
            payload: {
                elements: [
                    ...
                    },
                    {
                        ...
                        subtitle:
                            "Chất liệu cao cấp: Da Nappa mềm mại, bền bỉ. Thiết kế êm ái: Đế chống trượt, tạo cảm giác thoải mái tối ưu. Công dụng đa dạng: Lựa chọn hoàn hảo cho công sở, tiệc cưới và các sự kiện trang trọng.",
                        buttons: [
                            {
                                type: "postback",
                                title: "Chọn GT1002",
                    ...
                    },
                    {
                        ...
                        subtitle:
                            "Chất liệu da cao cấp: Đảm bảo độ bền và vẻ đẹp lâu dài. Thiết kế lịch lãm: Thích hợp cho mọi dịp từ công sở đến dự tiệc. Tôn dáng sang trọng: Giúp phái mạnh tự tin trong mọi hoàn cảnh. Sự thoải mái tối đa: Êm ái khi sử dụng, thích hợp cho việc đi lại cả ngày dài.",
                        buttons: [
                            {
                                type: "postback",
                                title: "Chọn GT1004",
                    ...
                    },
                    {
                        ...
                        subtitle:
                            "Chất Liệu Cao Cấp: Được làm từ da cao cấp, đảm bảo độ bền và vẻ đẹp sang trọng. Thiết Kế Thời Trang: Phù hợp với nhiều trang phục công sở và dự tiệc, giúp bạn luôn tự tin. Công Nghệ Chống Trơn: Đảm bảo an toàn khi di chuyển trên mọi địa hình. Sự Êm Ái: Thiết kế êm ái giúp bạn thoải mái suốt cả ngày dài.",
                        buttons: [
                            {
                                type: "postback",
                                title: "Chọn GT1005",
                    ...
                    },
                    {
                        ...
                        subtitle:
                            "Chất liệu cao cấp: Da bò thật sang trọng. Mũi giày tinh tế: Thiết kế mũi nhọn ấn tượng. Đế giày chống trượt: Đế cao su êm ái và chắc chắn. Tôn dáng lịch lãm: Giúp bạn tự tin hơn trong từng bước đi.",
                        buttons: [
                            {
                                type: "postback",
                                title: "Chọn GT1006",
                    ...
                    },
                    {
                        ...
                        subtitle:
                            "Chất liệu cao cấp: Da bò thật với vân cá sấu tinh tế, mang lại vẻ đẹp và độ bền cao. Sự thoải mái: Thiết kế êm ái, thoáng khí giúp bạn dễ chịu khi sử dụng cả ngày dài. An toàn khi di chuyển: Đế giày chống trượt đảm bảo sự an toàn trong mọi hoàn cảnh.",
                        buttons: [
                            {
                                type: "postback",
                                title: "Chọn GT1009",
                    ...
                    },
                    {
                        ...
                        subtitle:
                            "Màu sắc: Nâu sang trọng. Chất liệu: Da cao cấp. Thiết kế: Lịch lãm, phù hợp cho cả đi làm và đi chơi. Cảm giác thoải mái: Đế êm nhẹ, dễ chịu khi di chuyển. Cách phối đồ: Phong cách đẳng cấp quý ông",
                        buttons: [
                            {
                                type: "postback",
                                title: "Chọn GT1017",
                    ...
                    },
                    {
                        ...
                        subtitle:
                            "Chất liệu cao cấp: Da bò 100% cho độ bền vượt trội. Thiết kế thời trang: Phong cách trẻ trung, phù hợp với các quý ông hiện đại. Cao 4 cm: Đế giày giúp bạn tự tin hơn trong từng bước đi mà vẫn thoải mái.",
                        buttons: [
                            {
                                type: "postback",
                                title: "Chọn GT1019",
                    ...
                    },
                    {
                        ...
                        subtitle:
                            "Chất liệu cao cấp: Da bò chất lượng, bền bỉ và dễ bảo quản. Cao 4cm: Thiết kế độc đáo giúp tăng chiều cao mà vẫn thoải mái. Khoá kim loại chống rỉ: Tạo điểm nhấn cho giày, nâng cao tính thẩm mỹ và độ bền.",
                        buttons: [
                            {
                                type: "postback",
                                title: "Chọn GT1023",
            ...
            payload: {
                elements: [
                    ...
                    },
                    {
                        ...
                        subtitle:
                            "Thiết Kế Lịch Lãm: Phong cách sang trọng, đẳng cấp cho mọi sự kiện. Chất Liệu Da Cao Cấp: Đảm bảo độ bền và vẻ đẹp theo thời gian. Êm Ái Cả Ngày: Thoải mái cho cả ngày dài, phù hợp đi làm hoặc đi chơi.",
                        buttons: [
                            {
                                type: "postback",
                                title: "Chọn GM1014",
                    ...
                    },
                    {
                        ...
                        subtitle:
                            "Màu sắc: Đen lịch lãm. Chất liệu: Da cao cấp, bền đẹp. Kết cấu: Khóa kim loại sang trọng. Cảm giác: Êm ái, thoải mái cho từng bước chân. Sự kiện sử dụng:Cực kỳ phù hợp khi đi làm hoặc đi chơi.",
                        buttons: [
                            {
                                type: "postback",
                                title: "Chọn GM1016",
                    ...
                    },
                    {
                        ...
                        subtitle:
                            "Chất liệu cao cấp: Da bò thật mang lại độ bền cao. Thiết kế gọn nhẹ: Dễ dàng di chuyển và phù hợp với nhiều trang phục. An toàn khi di chuyển: Chất liệu chống trơn trượt giúp bạn tự tin hơn mỗi bước đi.",
                        buttons: [
                            {
                                type: "postback",
                                title: "Chọn GM2205",
                ...
                elements: [
                    {
                        ...
                        subtitle:
                            "Chất liệu da bò thật: Mềm mại, bền bỉ cho cảm giác dễ chịu khi mang. Đường may tinh tế: Tạo nên vẻ ngoài sang trọng và chắc chắn. Đế chống trượt: Đảm bảo an toàn trong từng bước đi.",
                        buttons: [
                            {
                                type: "postback",
                                title: "Chọn SP1007",
                    ...
                    },
                    {
                        ...
                        subtitle:
                            "Thiết kế thanh lịch: Với kiểu dáng trung tính, giày phù hợp cho nhiều dịp khác nhau. Chất liệu cao cấp: Quai da và lót da mang đến cảm giác thoải mái và bền bỉ khi sử dụng. Tính linh hoạt: Dễ dàng phối hợp với nhiều trang phục khác nhau, từ công sở đến dạo phố.",
                        buttons: [
                            {
                                type: "postback",
                                title: "Chọn SP1015",
                    ...
                    },
                    {
                        ...
                        subtitle:
                            "Chất liệu cao cấp: Quai da và lót da mang lại cảm giác êm ái khi sử dụng. Công nghệ chống rỉ: Khóa hợp kim chống rỉ sét giúp tăng độ bền cho sản phẩm. Thiết kế thông minh: Đế bằng, dễ dàng thay dép và sử dụng hàng ngày.",
                        buttons: [
                            {
                                type: "postback",
                                title: "Chọn SP1022",
        ...
        chon_GT1001: {
            ...
            payload: {
                variable: "product",
                value: "Giày Tây GT1001 {{variable}}",
            },
            next: "ask_name",
        },
        chon_GT1002: {
